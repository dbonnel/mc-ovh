...
\bloc{cyan}{Remarque}{% id="r10"
     Sur la plupart des calculatrices de collège la touche qui permet d'effectuer la division euclidienne est notée~: \imgsvg{touche-divise}{0.008}%width="8" alt="touche division euclidienne"
     .
     \par
