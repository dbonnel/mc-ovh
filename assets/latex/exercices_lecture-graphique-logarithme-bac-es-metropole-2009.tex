...
\\
%##
% type=table; width=35; l3=20; c2=15;c9=5
%--
% x|   -2   ~    0   ~   2  ~   ~  4 
% g'(x)|  ~       -               :0             +   :0   -     ~  ||
...
\begin{center}
 \begin{extern}%style="width:35rem" alt="Exercice"
    \resizebox{11cm}{!}{
       ...
       \def\width{.15}
       \def\height{.10}
       \draw (0, -10*\height) -- (84*\width, -10*\height);
       \draw (10*\width, 0*\height) -- (10*\width, -10*\height);
       \node (l0c0) at (5*\width,-5*\height) {$ x $};
       \node (l0c1) at (17.5*\width,-5*\height) {$ -2 $};
       \node (l0c2) at (30*\width,-5*\height) {$ ~ $};
       \node (l0c3) at (39*\width,-5*\height) {$ 0 $};
       \node (l0c4) at (48*\width,-5*\height) {$ ~ $};
       \node (l0c5) at (57*\width,-5*\height) {$ 2 $};
       \node (l0c6) at (66*\width,-5*\height) {$ ~ $};
       \node (l0c7) at (75*\width,-5*\height) {$ ~ $};
       \node (l0c8) at (81.5*\width,-5*\height) {$ 4 $};
       \draw (0, -20*\height) -- (84*\width, -20*\height);
       \draw (10*\width, -10*\height) -- (10*\width, -20*\height);
       \node (l1c0) at (5*\width,-15*\height) {$ g'(x) $};
       \node (l1c1) at (17.5*\width,-15*\height) {$ ~ $};
       \node (l1c2) at (30*\width,-15*\height) {$ - $};
       \draw[light] (39*\width, -10*\height) -- (39*\width, -20*\height);
       \node (l1c3) at (39*\width,-15*\height) {$ 0 $};
       \node (l1c4) at (48*\width,-15*\height) {$ + $};
       \draw[light] (57*\width, -10*\height) -- (57*\width, -20*\height);
       \node (l1c5) at (57*\width,-15*\height) {$ 0 $};
       \node (l1c6) at (66*\width,-15*\height) {$ - $};
       \node (l1c7) at (75*\width,-15*\height) {$ ~ $};
       \draw[double distance=2pt] (81.5*\width, -10*\height) -- (81.5*\width, -20*\height);
       \node (l1c8) at (81.5*\width,-15*\height) {$ ~ $};
       \draw (0, -40*\height) -- (84*\width, -40*\height);
       \draw (10*\width, -20*\height) -- (10*\width, -40*\height);
       \node (l2c0) at (5*\width,-30*\height) {$ g(x) $};
       \node (l2c1) at (17.5*\width,-25*\height) {$ 2\ln 3 $};
       \node (l2c2) at (30*\width,-30*\height) {$ ~ $};
       \draw[light] (39*\width, -20*\height) -- (39*\width, -40*\height);
       \node (l2c3) at (39*\width,-35*\height) {$ 2\ln 2 $};
       \node (l2c4) at (48*\width,-30*\height) {$ ~ $};
       \draw[light] (57*\width, -20*\height) -- (57*\width, -40*\height);
       \node (l2c5) at (57*\width,-25*\height) {$ \ln 5 $};
       \node (l2c6) at (66*\width,-30*\height) {$ ~ $};
       \node (l2c7) at (75*\width,-35*\height) {$ -\infty $};
       \draw[double distance=2pt] (81.5*\width, -20*\height) -- (81.5*\width, -40*\height);
       \node (l2c8) at (81.5*\width,-30*\height) {$ ~ $};
       \draw (0, 0) rectangle (84*\width, -40*\height);
