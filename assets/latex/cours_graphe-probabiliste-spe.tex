...
\bloc{orange}{Exemples}{% id="e033"
     ...
     \begin{center}
          \imgsvg{matrice-transition-2x2-ltx}{0.4}%width="280" alt="matrice de transition 2x2"
     \end{center}
     \textbf{b. Graphe probabiliste d'ordre 3}
     \par
     ...
     \begin{center}
          \imgsvg{matrice-transition-3x3-ltx}{0.4}%width="320" alt="matrice de transition 3x3"
     \end{center}
}
