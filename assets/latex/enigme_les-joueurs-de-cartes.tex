...
\begin{itemize}
     ...
     \par
     Sur les $n-1$ premières manches, il a perdu $1+2+3+\cdots+n-1 =\frac{n(n-1)}{2}$ euros (voir formule \mcLien{/cours/premiere-s/suites-geometriques/#t60}{Somme des premiers entiers}).
     \par
     ...
     \par
     Cette équation du second degré ne possède pas de solution entière (voir \mcLien{/solver/outil-equation-du-2nd-degre/?a=1&b=-7&c=8}{résolution}).
     \par
     ~
     \item
