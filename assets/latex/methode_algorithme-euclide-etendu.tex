...
\par
On procède comme pour l'algorithme d'Euclide (voir \mcLien{/methodes/arithmetique/algorithme-euclide-etendu}{algorithme d'Euclide})  mais à chaque étape on cherche à écrire le reste $r$ comme combinaison linéaire de $a$ et de $b$.
...
\par
(le tableau ci-dessous peut être obtenu avec l'outil \mcLien{outils/coefficients-bezout?val_a=135&val_b=101}{Outil : Coefficient de Bézout})
