...
\bloc{orange}{Exemples}{
     ...
     \imgsvg{Venn}{0.33}{Diagramme de Venn}
}
...
\bloc{orange}{Exemple}{
     ...
     \begin{itemize}
          ...
          \imgsvg{Venn-complementaire}{0.3}{Diagramme de Venn - Complémentaire}
          ...
          \imgsvg{Venn-union}{0.3}{Diagramme de Venn - Union}
          ...
          \imgsvg{Venn-inter}{0.3}{Diagramme de Venn - Intersection}
     \end{itemize}
}
