...
%##
% type=table; width=35; l3=20; c1=20; c3=20
%--
% x|   0,5   ~   3  ~   8 
% f'(x)|           :0             +   :0   -     ~
...
\begin{center}
 \begin{extern}%style="width:35rem" alt="Exercice"
    \resizebox{11cm}{!}{
       ...
       \node (l0c1) at (24*\width,-5*\height) {$ 0,5 $};
       \node (l0c2) at (38*\width,-5*\height) {$ ~ $};
       \node (l0c3) at (52*\width,-5*\height) {$ 3 $};
       \node (l0c4) at (61*\width,-5*\height) {$ ~ $};
       \node (l0c5) at (70*\width,-5*\height) {$ 8 $};
       \draw (0, -20*\height) -- (74*\width, -20*\height);
       \draw (20*\width, -10*\height) -- (20*\width, -20*\height);
       \node (l1c0) at (10*\width,-15*\height) {$ f'(x) $};
       \draw[light] (24*\width, -10*\height) -- (24*\width, -20*\height);
       \node (l1c1) at (24*\width,-15*\height) {$ 0 $};
       \node (l1c2) at (38*\width,-15*\height) {$ + $};
       ...
       \draw (0, -40*\height) -- (74*\width, -40*\height);
       \draw (20*\width, -20*\height) -- (20*\width, -40*\height);
       \node (l2c0) at (10*\width,-30*\height) {$ f(x) $};
       \node (l2c1) at (24*\width,-35*\height) {$ -10 \text{e}^{ -0,25 } $};
       \node (l2c2) at (38*\width,-30*\height) {$ ~ $};
       \node (l2c3) at (52*\width,-25*\height) {$ 40 \text{e}^{-1,5 } $};
       \node (l2c4) at (61*\width,-30*\height) {$ ~ $};
       \node (l2c5) at (70*\width,-35*\height) {$ 140 \text{e}^{ -4} $};
       \draw (0, 0) rectangle (74*\width, -40*\height);
