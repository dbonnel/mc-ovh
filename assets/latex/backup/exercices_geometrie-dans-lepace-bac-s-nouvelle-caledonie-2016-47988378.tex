...
\begin{enumerate}
   ...
   \begin{tabularx}{0.8\linewidth}{|*{2}{>{\centering \arraybackslash }X|}}%class="singleborder" width="600"
               \hline
               \textbf{Variables :} 
\hline
...
$ \quad   $Pour $m^\prime$ allant de $-10$ à $10$ :
 \\ \hline
$ \quad  \quad   $Si $\left(mm^\prime\right)^2+16(m-1)\left(m^\prime-1\right)+4mm^\prime = 0$ Alors 
  \\ \hline
$ \quad  \quad  $Afficher $\left(m~;~m^\prime\right)$
 \\ \hline
$ \quad  $Fin du Pour
  \\ \hline
Fin du Pour
