...
\begin{center}
 \begin{extern}%style="width:30rem" alt="Fonction"
    \resizebox{11cm}{!}{
       ...
       \rput(-0.5,-0.5){$O$}
       \psplot[linewidth=1pt,plotpoints=2000,linecolor=blue]{\xmin}{\xmax}{x*x}
       \psplot[linewidth=1pt,plotpoints=2000,linecolor=red]{\xmin}{\xmax}{2*x-1}
       \rput[t](3.5,9){$\blue \mathscr{C}_f$}
       \end{pspicture*}
      }
   \end{extern}
\end{center}
