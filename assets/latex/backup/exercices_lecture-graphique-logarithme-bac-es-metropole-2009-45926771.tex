...
\\
%##
% type=table; width=35; l3=20; l3=20;c9=4
%--
% x|   -2   ~    0   ~   2  ~   ~  4 
% g'(x)|  ~       -               :0             +   :0   -     ~  ||
...
\begin{center}
 \begin{extern}%style="width:35rem" alt="Exercice"
    \resizebox{11cm}{!}{
       ...
       \def\width{.15}
       \def\height{.10}
       \draw (0, -10*\height) -- (76*\width, -10*\height);
       ...
       \node (l0c8) at (74*\width,-5*\height) {$ 4 $};
       \draw (0, -20*\height) -- (76*\width, -20*\height);
       ...
       \draw[double distance=2pt] (74*\width, -10*\height) -- (74*\width, -20*\height);
       \node (l1c8) at (74*\width,-15*\height) {$ ~ $};
       \draw (0, -40*\height) -- (76*\width, -40*\height);
       ...
       \draw[double distance=2pt] (74*\width, -20*\height) -- (74*\width, -40*\height);
       \node (l2c8) at (74*\width,-30*\height) {$ ~ $};
       \draw (0, 0) rectangle (76*\width, -40*\height);
