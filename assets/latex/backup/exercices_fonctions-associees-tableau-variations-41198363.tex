...
\begin{center}
 \begin{extern}%style="width:50rem" alt="Exercice"
    \resizebox{11cm}{!}{
       ...
       \def\width{.15}
       \def\height{.10}
       \draw (0, -10*\height) -- (108*\width, -10*\height);
       \draw (10*\width, 0*\height) -- (10*\width, -10*\height);
       \node (l0c0) at (5*\width,-5*\height) {$ x $};
       \node (l0c1) at (14*\width,-5*\height) {$ -\infty $};
       \node (l0c2) at (23*\width,-5*\height) {$ ~ $};
       ...
       \node (l0c6) at (59*\width,-5*\height) {$ 0 $};
       \node (l0c7) at (68*\width,-5*\height) {$ ~ $};
       \node (l0c8) at (77*\width,-5*\height) {$ ~ $};
       \node (l0c9) at (86*\width,-5*\height) {$ 2 $};
       \node (l0c10) at (95*\width,-5*\height) {$ ~ $};
       \node (l0c11) at (104*\width,-5*\height) {$ +\infty $};
       \draw (0, -20*\height) -- (108*\width, -20*\height);
       ...
       \draw[double distance=2pt] (59*\width, -10*\height) -- (59*\width, -20*\height);
       \node (l1c6) at (59*\width,-15*\height) {$ ~ $};
       \node (l1c7) at (68*\width,-12.5*\height) {$ ~ $};
       \node (l1c8) at (77*\width,-15*\height) {$ ~ $};
       \draw[light] (86*\width, -10*\height) -- (86*\width, -20*\height);
       \node (l1c9) at (86*\width,-17.5*\height) {$ -1 $};
       \node (l1c10) at (95*\width,-15*\height) {$ ~ $};
       \node (l1c11) at (104*\width,-12.5*\height) {$ ~ $};
       \draw (0, 0) rectangle (108*\width, -20*\height);
       \draw[fleche] (l1c1) -- (l1c3);
       \draw[fleche] (l1c3) -- (l1c5);
       \draw[fleche] (l1c7) -- (l1c9);
