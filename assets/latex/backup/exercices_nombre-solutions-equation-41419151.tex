...
%point=(-.5,0)(0,0);linecolor=red;dotsize=.1
%point=(.65,0)(0,0);linecolor=red;dotsize=.1
%point=(2.9,0)(0,0);linecolor=red;dotsize=.1
 ...
 \begin{extern}%style="width:30rem" alt="Fonction"
    \resizebox{11cm}{!}{
       ...
       \psplot[linewidth=1pt,plotpoints=2000,linecolor=blue]{\xmin}{\xmax}{x^3-3*x^2+1}
                    \psdots[dotsize=.1,linecolor=red](-.5,0)
       \rput(0,0){$\red $}
                    \psdots[dotsize=.1,linecolor=red](.65,0)
       \rput(0,0){$\red $}
                    \psdots[dotsize=.1,linecolor=red](2.9,0)
       \rput(0,0){$\red $}
