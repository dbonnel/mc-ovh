...
\begin{enumerate}
   ...
   \begin{tabularx}{0.8\linewidth}{|*{3}{>{\centering \arraybackslash }X|}}%class="singleborder" width="600"
               ...
               \\ \hline
Pour $m^\prime$ allant de $-10$ à $10$ :
 \\ \hline
Si $\left(mm^\prime\right)^2+16(m-1)\left(m^\prime-1\right)+4mm^\prime = 0$Alors 
  \\ \hline
Afficher $\left(m~;~m^\prime\right)$
  \\ \hline
Fin du Pour
  \\ \hline
Fin du Pour [/table]
              ...
              $ \ $  $ $Si $\left(mm^\prime\right)^2+16(m-1)\left(m^\prime-1\right)+4mm^\prime = 0$  
               \\ \hline
