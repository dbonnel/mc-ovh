...
\bloc{orange}{Exemple 1}{ % id=e020
     ...
     \begin{enumerate}
          ...
          \begin{center}
\imgsvg{determiner-le-centre-et-le-rayon-dun-cercle}{0.3}% alt="Déterminer le centre et le rayon d'un cercle" style="width:30rem" class="aligncenter"          \end{center}
