...
\begin{center}
 \begin{extern}%style="width:50rem" alt="Exercice"
    \resizebox{11cm}{!}{
       ...
       \draw (0, -30*\height) -- (108*\width, -30*\height);
       \draw (10*\width, -10*\height) -- (10*\width, -30*\height);
       \node (l1c0) at (5*\width,-20*\height) {$ f $};
       ...
       \draw[double distance=2pt] (59*\width, -10*\height) -- (59*\width, -30*\height);
       \node (l1c6) at (59*\width,-20*\height) {$ ~ $};
       \node (l1c7) at (68*\width,-15*\height) {$ ~ $};
       \node (l1c8) at (77*\width,-20*\height) {$ ~ $};
       \draw[light] (86*\width, -10*\height) -- (86*\width, -30*\height);
       \node (l1c9) at (86*\width,-25*\height) {$ -1 $};
       \node (l1c10) at (95*\width,-20*\height) {$ ~ $};
       \node (l1c11) at (104*\width,-15*\height) {$ ~ $};
       \draw (0, 0) rectangle (108*\width, -30*\height);
       \draw[fleche] (l1c1) -- (l1c3);
       \draw[fleche] (l1c3) -- (l1c5);
       \draw[fleche] (l1c7) -- (l1c9);
