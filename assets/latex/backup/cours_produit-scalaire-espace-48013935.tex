...
\bloc{cyan}{Démonstration}{% id="m100"
 ...
 $ \Leftrightarrow   a\left(x-x_{A}\right)+b\left(y-y_{A}\right)+c\left(z-z_{A}\right)= 0$
 $M \in  \mathscr P $  $  \Leftrightarrow   \overrightarrow{AM}.\vec{n} = 0 \Leftrightarrow   ax+by+cz-ax_{A}-by_{A}-cz_{A}= 0$
     \par
