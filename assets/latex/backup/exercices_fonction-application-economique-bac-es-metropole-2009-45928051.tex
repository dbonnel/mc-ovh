...
%##
% type=table; width=35; l3=20; c2=20; c4=20
%--
% x|   0,5   ~   3  ~   8 
% f'(x)|           :0             +   :0   -     ~
...
\begin{center}
 \begin{extern}%style="width:35rem" alt="Exercice"
    \resizebox{11cm}{!}{
       ...
       \node (l0c3) at (50*\width,-5*\height) {$ 3 $};
       \node (l0c4) at (65*\width,-5*\height) {$ ~ $};
       \node (l0c5) at (74*\width,-5*\height) {$ 8 $};
       ...
       \node (l1c3) at (50*\width,-15*\height) {$ 0 $};
       \node (l1c4) at (65*\width,-15*\height) {$ - $};
       \node (l1c5) at (74*\width,-15*\height) {$ ~ $};
       ...
       \node (l2c3) at (50*\width,-25*\height) {$ 40 \text{e}^{-1,5 } $};
       \node (l2c4) at (65*\width,-30*\height) {$ ~ $};
       \node (l2c5) at (74*\width,-35*\height) {$ 140 \text{e}^{ -4} $};
