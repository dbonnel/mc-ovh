...
\begin{center}
 \begin{extern}%style="width:45rem" alt="Exercice"
    \resizebox{11cm}{!}{
       ...
       \node (l0c3) at (52*\width,-5*\height) {$ \frac{ 4 }{ 3 } $};
       \node (l0c4) at (61*\width,-5*\height) {$ ~ $};
       \node (l0c5) at (70*\width,-5*\height) {$ 3 $};
       ...
       \node (l1c0) at (15*\width,-15*\height) {$ x-3 $};
       ...
       \draw (0, -30*\height) -- (92*\width, -30*\height);
       \draw (30*\width, -20*\height) -- (30*\width, -30*\height);
       \node (l2c0) at (15*\width,-25*\height) {$ 4-3x $};
       \node (l2c1) at (34*\width,-25*\height) {$ ~ $};
       \node (l2c2) at (43*\width,-25*\height) {$ + $};
       \draw[light] (52*\width, -20*\height) -- (52*\width, -30*\height);
       \node (l2c3) at (52*\width,-25*\height) {$ 0 $};
       \node (l2c4) at (61*\width,-25*\height) {$ - $};
       \draw[light] (70*\width, -20*\height) -- (70*\width, -30*\height);
       \node (l2c5) at (70*\width,-25*\height) {$  $};
       \node (l2c6) at (79*\width,-25*\height) {$ - $};
       \node (l2c7) at (88*\width,-25*\height) {$ ~ $};
       \draw (0, -40*\height) -- (92*\width, -40*\height);
       \draw (30*\width, -30*\height) -- (30*\width, -40*\height);
       \node (l3c0) at (15*\width,-35*\height) {$ (x-3)(4-3x) $};
       \node (l3c1) at (34*\width,-35*\height) {$ ~ $};
       \node (l3c2) at (43*\width,-35*\height) {$ - $};
       \draw[light] (52*\width, -30*\height) -- (52*\width, -40*\height);
       \node (l3c3) at (52*\width,-35*\height) {$ 0 $};
       \node (l3c4) at (61*\width,-35*\height) {$ + $};
       \draw[light] (70*\width, -30*\height) -- (70*\width, -40*\height);
       \node (l3c5) at (70*\width,-35*\height) {$ 0 $};
       \node (l3c6) at (79*\width,-35*\height) {$ - $};
       \node (l3c7) at (88*\width,-35*\height) {$ ~ $};
       \draw (0, 0) rectangle (92*\width, -40*\height);
