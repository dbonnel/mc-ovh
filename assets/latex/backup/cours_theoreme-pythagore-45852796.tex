...
\cadre{bleu}{Définitions}{% id="d50"
     ...
     \begin{itemize}
          ...
          \par
          $\sin\left(\widehat{ABC}\right)=$\nosp$\frac{\text{longueur\ du\ côté\ opposé\ à\ B}}{\text{longueur\ de\ l} ^{\prime} \text{hypoténuse}}$
          \item le \textbf{cosinus} de $\widehat{ABC}$ est le nombre :
          \par
          $\cos\left(\widehat{ABC}\right)=$\nosp$\frac{\text{longueur\ du\ côté\ adjacent\ à\ B}}{\text{longueur\ de\ l} ^{\prime} \text{hypoténuse}}$
