...
\\
%##
% type=table; width=35; l3=20; l3=20;c9=5
%--
% x|   -2   ~    0   ~   2  ~   ~  4 
% g'(x)|  ~       -               :0             +   :0   -     ~  ||
...
\begin{center}
 \begin{extern}%style="width:35rem" alt="Exercice"
    \resizebox{11cm}{!}{
       ...
       \node (l0c8) at (74.5*\width,-5*\height) {$ 4 $};
       ...
       \draw[double distance=2pt] (74.5*\width, -10*\height) -- (74.5*\width, -20*\height);
       \node (l1c8) at (74.5*\width,-15*\height) {$ ~ $};
       ...
       \draw[double distance=2pt] (74.5*\width, -20*\height) -- (74.5*\width, -40*\height);
       \node (l2c8) at (74.5*\width,-30*\height) {$ ~ $};
