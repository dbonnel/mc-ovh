...
[table class=noborder left]\textbf{Initialisation }: | $T$ prend la valeur $25$
\textbf{Traitement }: |Demander la valeur de $n$
\par
|Pour $i$ allant de $1$ à $n$ faire
\par
|$\quad \quad T$ prend la valeur $0,85 \times T + 15$
\par
|Fin Pour
\textbf{Sortie }: |Afﬁcher $T$[/table]
}
\begin{enumerate}
     \item
...
\begin{corrige}
     ...
     \begin{enumerate}
          ...
          \begin{note}\textbf{Attention au sens :}$\ln(0,85)$ est négatif~!\end{note}
