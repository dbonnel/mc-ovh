...
\meta{type}{exercices}
%
Sur la figure ci-dessous, $A$ et $I$ sont les points de coordonnées respectives $(-1;0)$ et $(1;0)$, $B$ est le point du cercle de centre $ O $ et de rayon 1 tel que l'angle $  \widehat{  } @ $ et $H$ le pied de la hauteur issue de $B$ du triangle $OBA$.
