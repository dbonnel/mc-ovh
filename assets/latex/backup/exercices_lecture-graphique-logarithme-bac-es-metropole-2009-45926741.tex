...
\\
%##
% type=table; width=35; l3=20; l3=20;c5=5
%--
% x|   -2   ~    0   ~   2  ~   ~  4 
% g'(x)|  ~       -               :0             +   :0   -     ~  ||
...
\begin{center}
 \begin{extern}%style="width:35rem" alt="Exercice"
    \resizebox{11cm}{!}{
       ...
       \def\width{.15}
       \def\height{.10}
       \draw (0, -10*\height) -- (77*\width, -10*\height);
       ...
       \node (l0c4) at (38.5*\width,-5*\height) {$ ~ $};
       \node (l0c5) at (45*\width,-5*\height) {$ 2 $};
       \node (l0c6) at (54*\width,-5*\height) {$ ~ $};
       \node (l0c7) at (63*\width,-5*\height) {$ ~ $};
       \node (l0c8) at (72*\width,-5*\height) {$ 4 $};
       \draw (0, -20*\height) -- (77*\width, -20*\height);
       ...
       \node (l1c4) at (38.5*\width,-15*\height) {$ + $};
       \draw[light] (45*\width, -10*\height) -- (45*\width, -20*\height);
       \node (l1c5) at (45*\width,-15*\height) {$ 0 $};
       \node (l1c6) at (54*\width,-15*\height) {$ - $};
       \node (l1c7) at (63*\width,-15*\height) {$ ~ $};
       \draw[double distance=2pt] (72*\width, -10*\height) -- (72*\width, -20*\height);
       \node (l1c8) at (72*\width,-15*\height) {$ ~ $};
       \draw (0, -40*\height) -- (77*\width, -40*\height);
       ...
       \node (l2c4) at (38.5*\width,-30*\height) {$ ~ $};
       \draw[light] (45*\width, -20*\height) -- (45*\width, -40*\height);
       \node (l2c5) at (45*\width,-25*\height) {$ \ln 5 $};
       \node (l2c6) at (54*\width,-30*\height) {$ ~ $};
       \node (l2c7) at (63*\width,-35*\height) {$ -\infty $};
       \draw[double distance=2pt] (72*\width, -20*\height) -- (72*\width, -40*\height);
       \node (l2c8) at (72*\width,-30*\height) {$ ~ $};
       \draw (0, 0) rectangle (77*\width, -40*\height);
