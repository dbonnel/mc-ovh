...
\begin{center}
     \imgsvg{globe}{0.1}%width="130" alt="trophée Brevet Métropole 2018"
\end{center}
\begin{enumerate}
     \item Le biathlète français Martin Fourcade a remporté le sixième gros globe de cristal de sa carrière en 2017 à Pyeongchang en Corée du Sud.
     \par
     Donner approximativement la latitude et la longitude de ce lieu repéré sur la carte
     ci-dessous.
     \medbreak
     \begin{center}
          \imgsvg{mappemonde}{0.6}%width="700" alt="Mappemonde Brevet Métropole 2018"
     \end{center}
