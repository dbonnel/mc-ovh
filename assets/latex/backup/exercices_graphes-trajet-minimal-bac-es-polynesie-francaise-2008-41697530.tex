...
\end{center}
     ...
     \end{enumerate}
     \item
     Le lendemain, il envisage de rejoindre le plus rapidement possible la station $G$ en partant de la station A. A l'aide d'un algorithme, déterminier un tel parcours et donner alors le temps nécessaire pour l'effectuer.
\end{enumerate}
