...
\bloc{cyan}{Remarque:}{ % id=r030
     ...
     \begin{center}
          \begin{extern}%style="width:35rem" alt="perpendiculaires et parallèles "
...
\begin{center}
     \imgsvg{reciproque-thales}{0.1}%style="width:35rem" alt="thales et reciproque"
\end{center}
...
\begin{center}
     \begin{extern}%style="width:35rem" alt="réciproque du théorème de Thalès"
          \newrgbcolor{tttttt}{0.2 0.2 0.2}
          \psset{xunit=1.0cm,yunit=1.0cm,algebraic=true,dimen=middle,dotstyle=o,dotsize=5pt 0,linewidth=1.6pt,arrowsize=3pt 2,arrowinset=0.25}
