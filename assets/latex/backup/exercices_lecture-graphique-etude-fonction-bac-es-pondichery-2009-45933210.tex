...
\begin{center}
 \begin{extern}%style="width:35rem" alt="Exercice"
    \resizebox{11cm}{!}{
       ...
       \node (l2c2) at (23*\width,-35*\height) {$ ~ $};
       \node (l2c3) at (32*\width,-35*\height) {$ ~ $};
       \draw[light] (41*\width, -20*\height) -- (41*\width, -40*\height);
       \node (l2c4) at (41*\width,-25*\height) {$ 5 $};
       \node (l2c5) at (50*\width,-30*\height) {$ ~ $};
       \draw (0, 0) rectangle (54*\width, -40*\height);
       \draw[fleche] (l2c1) -- (l2c3);
       \draw[fleche] (l2c2) -- (l2c4);
       \draw[fleche] (l2c4) -- (l2c6);
       \end{tikzpicture}
      }
   \end{extern}
\end{center}
