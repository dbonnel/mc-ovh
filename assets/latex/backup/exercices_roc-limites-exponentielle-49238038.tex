...
\begin{center}
 \begin{extern}%style="width:35rem" alt="Exercice"
    \resizebox{11cm}{!}{
       ...
       \def\width{.15}
       \def\height{.10}
       \draw (0, -10*\height) -- (46*\width, -10*\height);
       ...
       \node (l0c3) at (32*\width,-5*\height) {$ ~ $};
       \node (l0c4) at (41*\width,-5*\height) {$ +\infty $};
       \draw (0, -20*\height) -- (46*\width, -20*\height);
       ...
       \draw (0, -40*\height) -- (46*\width, -40*\height);
       ...
       \draw (0, 0) rectangle (46*\width, -40*\height);
