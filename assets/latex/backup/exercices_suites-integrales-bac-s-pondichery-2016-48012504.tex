...
\par
Pour cela, on la prend à la température ambiante   $ T_0 = 25 C $$  \pi  $et on la place dans un four à température constante $T_F = 100 $ C.
\par
...
\\
$ \phantom{T_{n+1}}=0,85 \times 0,85^n=0,85^{n+1}$  
...
\textbf{Attention au sens :}$\ln(0,85)$ est négatif~!}
