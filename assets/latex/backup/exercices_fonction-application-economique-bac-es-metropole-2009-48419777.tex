...
%##
% type=table; width=35; l3=20; c2=16; c6=14
%--
% x|   0,5   ~   3  ~   8 
% f'(x)|           :0             +   :0   -     ~
% f(x)|  -10 \text{e}^{ -0,25 }  /  40 \text{e}^{-1,5 }     \  140 \text{e}^{ -4}
%--
\begin{center}
 \begin{extern}%style="width:35rem" alt="Exercice"
    \resizebox{11cm}{!}{
       ...
       \def\width{.15}
       \def\height{.10}
       \draw (0, -10*\height) -- (68*\width, -10*\height);
       \draw (10*\width, 0*\height) -- (10*\width, -10*\height);
       \node (l0c0) at (5*\width,-5*\height) {$ x $};
       \node (l0c1) at (18*\width,-5*\height) {$ 0,5 $};
       \node (l0c2) at (31*\width,-5*\height) {$ ~ $};
       \node (l0c3) at (40*\width,-5*\height) {$ 3 $};
       \node (l0c4) at (49*\width,-5*\height) {$ ~ $};
       \node (l0c5) at (61*\width,-5*\height) {$ 8 $};
       \draw (0, -20*\height) -- (68*\width, -20*\height);
       \draw (10*\width, -10*\height) -- (10*\width, -20*\height);
       \node (l1c0) at (5*\width,-15*\height) {$ f'(x) $};
       \draw[light] (18*\width, -10*\height) -- (18*\width, -20*\height);
       \node (l1c1) at (18*\width,-15*\height) {$ 0 $};
       \node (l1c2) at (31*\width,-15*\height) {$ + $};
       \draw[light] (40*\width, -10*\height) -- (40*\width, -20*\height);
       \node (l1c3) at (40*\width,-15*\height) {$ 0 $};
       \node (l1c4) at (49*\width,-15*\height) {$ - $};
       \node (l1c5) at (61*\width,-15*\height) {$ ~ $};
       \draw (0, -40*\height) -- (68*\width, -40*\height);
       \draw (10*\width, -20*\height) -- (10*\width, -40*\height);
       \node (l2c0) at (5*\width,-30*\height) {$ f(x) $};
       \node (l2c1) at (18*\width,-35*\height) {$ -10 \text{e}^{ -0,25 } $};
       \node (l2c2) at (31*\width,-30*\height) {$ ~ $};
       \node (l2c3) at (40*\width,-25*\height) {$ 40 \text{e}^{-1,5 } $};
       \node (l2c4) at (49*\width,-30*\height) {$ ~ $};
       \node (l2c5) at (61*\width,-35*\height) {$ 140 \text{e}^{ -4} $};
       \draw (0, 0) rectangle (68*\width, -40*\height);
...
\begin{center}
\imgsvg{bac-es-2009-fct2}{0.3}% alt="Étude d'une fonction - Application économique - Bac ES Métropole 2009" style="width:40rem"
\end{center}
