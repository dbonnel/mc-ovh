...
\begin{center}
 \begin{extern}%style="width:35rem" alt="Exercice"
    \resizebox{11cm}{!}{
       ...
       \node (l2c1) at (14*\width,-35*\height) {$ -10 \text{e}^{ -0,25 } $};
       \node (l2c2) at (23*\width,-30*\height) {$ ~ $};
       \node (l2c3) at (32*\width,-25*\height) {$ 40 \text{e}^{-1,5 } $};
       \node (l2c4) at (41*\width,-30*\height) {$ ~ $};
       \node (l2c5) at (50*\width,-35*\height) {$ 140 \text{e}^{ -4} $};
