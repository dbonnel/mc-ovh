...
% xmin=-3.5; xmax=4.5; ymin=-3.9; ymax=4.5; xunit=1; yunit=1
%--
%grid=1;subgriddiv=1
%repere=0
%axes=1
%fct=x^3-3*x^2+1;linecolor=blue
%point=(-.52,0)(0,0);linecolor=red;dotsize=.15
%point=(.65,0)(0,0);linecolor=red;dotsize=.15
%point=(2.87,0)(0,0);linecolor=red;dotsize=.15
 ...
 \begin{extern}%style="width:30rem" alt="Fonction"
    \resizebox{11cm}{!}{
       ...
       \psplot[linewidth=1pt,plotpoints=2000,linecolor=blue]{\xmin}{\xmax}{x^3-3*x^2+1}
                    \psdots[dotsize=.15,linecolor=red](-.52,0)
       \rput(0,0){$\red $}
                    \psdots[dotsize=.15,linecolor=red](.65,0)
       \rput(0,0){$\red $}
                    \psdots[dotsize=.15,linecolor=red](2.87,0)
       \rput(0,0){$\red $}
