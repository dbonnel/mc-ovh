...
\medskip
\emph{Cet exercice est un questionnaire à choix multiples. Pour chacune des questions suivantes, une seule des quatre propositions est exacte. 
\\
Aucune justification n'est demandée. 
\\
Une bonne réponse rapporte un point. Une mauvaise réponse, plusieurs réponses ou l'absence de réponse à une question ne rapportent ni n'enlèvent de point. Pour répondre, vous recopierez \textbf{sur votre copie} le numéro de la question et indiquerez la seule bonne réponse.}
\par
